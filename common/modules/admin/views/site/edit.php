...
/* @var $model common\modules\admin\models\SiteForm */
/* @var $form ActiveForm */
$this->title = Module::t('app', 'Editing the Site');
?>
...
<div class="form-group">
    ...
    <?php foreach ($model->roles as $i => $role): ?>
        <div class="checkbox">
            <label>
                <?= Html::checkbox('SiteForm[roles][]', $role["selected"], ['value' => $role["name"]]) ?> <?= Module::t('app', $role["name"]) ?>
            </label>
        </div>
    <?php endforeach; ?>
</div
